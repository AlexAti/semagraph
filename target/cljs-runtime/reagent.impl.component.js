...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__8167 = c;
var G__8167__$1 = (((G__8167 == null))?null:G__8167.prototype);
if((G__8167__$1 == null)){
return null;
} else {
return G__8167__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__8171 = c;
var G__8171__$1 = (((G__8171 == null))?null:G__8171.prototype);
if((G__8171__$1 == null)){
return null;
} else {
return G__8171__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__8212 = c;
var G__8212__$1 = (((G__8212 == null))?null:G__8212.constructor);
if((G__8212__$1 == null)){
return null;
} else {
return G__8212__$1.displayName;
}
})();
...
var G__8220 = c;
var G__8220__$1 = (((G__8220 == null))?null:G__8220.constructor);
if((G__8220__$1 == null)){
return null;
} else {
return G__8220__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__8242 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__8243 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__8243);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__8242);
}});
...
var c = this;
var G__8293_8412 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__8293_8412 == null)){
} else {
reagent.ratom.dispose_BANG_(G__8293_8412);
}
...
var renders_8413 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_8414 = cljs.core.first(cljs.core.vals(renders_8413));
...
if((cljs.core.count(renders_8413) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_8413))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_8414)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_8414], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__8333 = o;
reagent.impl.component.goog$module$goog$object.set(G__8333,cljs.core.name(k),v);
...
while (G__8423__i < G__8423__a.length) {G__8423__a[G__8423__i] = arguments[G__8423__i + 0]; ++G__8423__i;}
  args = new cljs.core.IndexedSeq(G__8423__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__8387 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__8388 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__8388);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__8387);
}});
...
var vec__8389 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8389,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8389,(1),null);
...
var G__8394 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__8394 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__8394);
}
});
}),[]);
