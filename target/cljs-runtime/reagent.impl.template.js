...
var G__8500 = o;
reagent.impl.template.goog$module$goog$object.set(G__8500,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__8548__delegate = function (args){
...
var G__8501 = o;
reagent.impl.template.goog$module$goog$object.set(G__8501,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__8556__i = 0, G__8556__a = new Array(arguments.length -  0);
while (G__8556__i < G__8556__a.length) {G__8556__a[G__8556__i] = arguments[G__8556__i + 0]; ++G__8556__i;}
  args = new cljs.core.IndexedSeq(G__8556__a,0,null);
} 
...
var G__8502 = props;
var G__8502__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8502,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8502);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8502__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8504 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8504,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8504;
}
})(),id_class);
...
var G__8505 = (cljs.core.count(argv) - first_child);
switch (G__8505) {
case (0):
...
var vec__8506 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8506,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8506,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8506,(2),null);
...
var temp__5808__auto___8570 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8570 == null)){
} else {
var key_8571 = temp__5808__auto___8570;
(jsprops.key = key_8571);
}
...
var temp__5808__auto___8573 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8573 == null)){
} else {
var key_8574 = temp__5808__auto___8573;
(jsprops.key = key_8574);
}
...
var temp__5808__auto___8577 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___8577 == null)){
} else {
var key_8580 = temp__5808__auto___8577;
(jsprops.key = key_8580);
}
...
var temp__5808__auto___8588 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8588 == null)){
} else {
var key_8590 = temp__5808__auto___8588;
...
var temp__5808__auto___8593 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8593 == null)){
} else {
var key_8594 = temp__5808__auto___8593;
(jsprops.key = key_8594);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8519_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8519_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8520 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8520,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8520,(1),null);
...
break;
default:
var G__8610 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__8611 = compiler;
v = G__8610;
compiler = G__8611;
continue;
...
var G__8528 = tag;
var G__8528__$1 = (((G__8528 instanceof cljs.core.Keyword))?G__8528.fqn:null);
switch (G__8528__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template8530 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template8530 = (function (opts,id,fn_to_element,parse_fn,meta8531){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template8530.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8532,meta8531__$1){
var self__ = this;
var _8532__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8530(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8531__$1));
}));

(reagent.impl.template.t_reagent$impl$template8530.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8532){
var self__ = this;
var _8532__$1 = this;
return self__.meta8531;
}));

(reagent.impl.template.t_reagent$impl$template8530.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8530.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8530.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template8530.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8530.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8530.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta8531","meta8531",-1218255266,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8530.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8530.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8530");

(reagent.impl.template.t_reagent$impl$template8530.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template8530");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8530.
 */
reagent.impl.template.__GT_t_reagent$impl$template8530 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template8530(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8531){
return (new reagent.impl.template.t_reagent$impl$template8530(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta8531));
});

}

return (new reagent.impl.template.t_reagent$impl$template8530(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
