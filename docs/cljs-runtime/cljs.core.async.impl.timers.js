...
var i_15530 = (0);
while(true){
if((i_15530 < arr.length)){
(arr[i_15530] = null);

var G__15532 = (i_15530 + (1));
i_15530 = G__15532;
continue;
} else {
}
...
var i_15540 = (self__.level + (1));
while(true){
if((i_15540 <= (new_level + (1)))){
(update[i_15540] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_15542 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_15542[i]));
} else {
x__$2.forward.push((((i < links_15542.length))?(links_15542[i]):null));
}

if((i < links_15542.length)){
(links_15542[i] = x__$2);
} else {
links_15542.push(x__$2);
}
...
var i_15545 = (0);
while(true){
if((i_15545 <= self__.level)){
var links_15546 = (update[i_15545]).forward;
if((x__$1 === (((i_15545 < links_15546.length))?(links_15546[i_15545]):null))){
(links_15546[i_15545] = (x__$1.forward[i_15545]));

var G__15547 = (i_15545 + (1));
i_15545 = G__15547;
continue;
} else {
var G__15548 = (i_15545 + (1));
i_15545 = G__15548;
continue;
}
} else {
...
var G__15550 = nx;
var G__15551 = (level__$1 - (1));
x = G__15550;
level__$1 = G__15551;
continue;
} else {
var G__15552 = x;
var G__15553 = (level__$1 - (1));
x = G__15552;
level__$1 = G__15553;
continue;
}
