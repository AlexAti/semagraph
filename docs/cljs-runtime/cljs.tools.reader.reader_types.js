...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13593 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13593(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13594 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13594(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13595 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13595(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13596 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13596(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13597 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13597(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13599 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13599(reader);
}
});
...
var G__13631 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13632 = s.append(c);
c = G__13631;
s = G__13632;
continue;
}
