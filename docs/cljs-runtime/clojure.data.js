...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__15737){
...
var vec__15756 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15756,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15756,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15756,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_15903 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_15903(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_15919 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_15919(a,b);
}
});
...
var fexpr__15877 = (function (){var G__15878 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15878__$1)].join('')));

}
})();
return (fexpr__15877.cljs$core$IFn$_invoke$arity$2 ? fexpr__15877.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__15877.call(null,a,b));
}));
/**
